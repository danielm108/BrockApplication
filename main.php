...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
    ...
    <title>Brock Environmental Services</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Brock Environmental Services</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#portfolio">Map</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#about">Route</a>
            </li>
            <li class="nav-item">
    ...
    <header class="masthead">
      <div class="container">
        <!-- <img class="img-fluid" src="img/BrockLOGO_Shrt_Nar.jpg" alt=""> -->
        <div class="intro-text">
          <!-- <span class="name">Brock environmental Services</span> -->
          <hr class="star-light">
          <span class="skills">Route Planner</span>
        </div>
      </div>
    </header>
    ...
    <h2 class="text-center">Route Map Demo</h2>
        <?php
          include('map.php');
        ?>
        ...
        <div class="container">
          <div class="row">
            <div class="footer-col col-md-4">
              <h3>Location</h3>
              <p>5332 Rochelle Road 
                <br>Rockwall, TX 75032</p>
            </div>
            <div class="footer-col col-md-4">
            ...
            <div class="footer-col col-md-4">
              <h3>About D&ampB Freelancing</h3>
              <p>Web Dev Services
                <a href='#'>Start Now</a>.</p>
            </div>
          </div>
        </div>
      </div>
